...
spec = matrix(c(
  ...
  'plotPDF',        'P', 1, "logical",   "plot pdf or not"
), byrow=TRUE, ncol=5)
...
#opt <- list(baseDir="/groups/veeken/user/markus.jaritz/projects/Christina/2024Feb29/results/umi",forVar=NULL,countsFile="process/featureCounts/intron_genecounts.txt", specnorm='^ENSMUSG|^TCR|^IGH',nidcols=6,idcol=1,minMean=50,minSingle=100,nhit=15,resultsDir="results/PCA",RDSoutdir="process/PCA",samplesFile="description/covars_ar.txt",reportTemplate="/groups/veeken/user/markus.jaritz/projects/Christina/2024Feb29/results/umi/code/pca_report_template.Rmd",widthsCol=6)
...
#print(sub(".txt$|.tsv$", ".scaled.txt", file.path(opt$baseDir, opt$countsFile)))
